 ...
 * Tue Sep 28 2021 22:31:56 GMT+1000 (Владивосток, стандартное время)
...
function createObject(type, name, width, height, depth, radius, tube, segments, cameraType, lightType, fov) {
    ...
    if (geometry)
        appInstance.updateObjectMaterialEnv(obj);
...
// show and hide puzzles
function openCloseAnnotation(objNames, bool) {
    objNames = retrieveObjectNames(objNames);
    if (!objNames)
        return;
    for (var i = 0; i < objNames.length; i++) {
...
registerOnHover('osnova', false, function() {
  ...
  registerOnClick('osnova', false, false, [0,1,2], function() {
    outline('osnova', 'ENABLE');
    replaceTexture('osnova_main', '1_0-specular.png.001', textura_img, function() {});
  }, function() {});
}, function() {
...
registerOnHover('poduski', false, function() {
  ...
  registerOnClick('poduski', false, false, [0,1,2], function() {
    outline('poduski', 'ENABLE');
    replaceTexture('posushki_small', 'КОР_1-texture_001.jpg', textura_img, function() {});
  }, function() {});
}, function() {
...
registerOnHover('karkas', false, function() {
  ...
  registerOnClick('karkas', false, false, [0,1,2], function() {
    outline('karkas', 'ENABLE');
    replaceTexture('karkas', '1_3.jpg.001', textura_img, function() {});
  }, function() {});
}, function() {
...
eventHTMLElem('click', 'm_odnoton_ind', true, function(event) {
  ...
  registerOnHover('osnova', false, function() {
    ...
    registerOnClick('osnova', false, false, [0,1,2], function() {
      outline('osnova', 'ENABLE');
      replaceTexture('osnova_main', '1_0-specular.png.001', textura_img_ind, function() {});
  ...
  registerOnHover('poduski', false, function() {
    ...
    registerOnClick('poduski', false, false, [0,1,2], function() {
      outline('poduski', 'ENABLE');
      replaceTexture('posushki_small', 'КОР_1-texture_001.jpg', textura_img_ind, function() {});
      textura_img_ind = textura_img;
    }, function() {});
  }, function() {
    outline('poduski', 'DISABLE');
  ...
  registerOnHover('karkas', false, function() {
    ...
    registerOnClick('karkas', false, false, [0,1,2], function() {
      outline('karkas', 'ENABLE');
      replaceTexture('karkas', '1_3.jpg.001', textura_img_ind, function() {});
      textura_img_ind = textura_img;
    }, function() {});
  }, function() {
    outline('karkas', 'DISABLE');
...
createObject('BOX', 'A', 0.1, 0.1, 0.1, 0, 0, 0, 'PERSPECTIVE', 'AMBIENT', 0);
...
eventHTMLElem('click', 'question_on', true, function(event) {
  handleAnnot(true, '', 'em_karkaz', 'Артикул ткани: ' + String(dictGet(dict_kat, 'karkas_kat_code')), '');
  handleAnnot(true, '', 'em_osnova', 'Артикул ткани: ' + String(dictGet(dict_kat, 'osn_kat_code')), '');
  handleAnnot(true, '', 'em_podushki', 'Артикул ткани: ' + String(dictGet(dict_kat, 'poduski_kat_code')), '');
});
eventHTMLElem('click', 'question_off', true, function(event) {
  handleAnnot(false, '', ['ALL_OBJECTS'], '', '');
});

console.log(getDistanceBetweenObjects('B', 'A'));
registerOnDrag('A', false, function() {}, function() {
...
eventHTMLElem('click', 'rotation_m', true, function(event) {
  handleAnnot(true, 'основа', 'em_osnova', dictGet(dict_kat, 'osn_kat_code'), 'f1');
  handleAnnot(true, 'карказ', 'em_karkaz', dictGet(dict_kat, 'karkas_kat_code'), 'f2');
  handleAnnot(true, 'подушки', 'em_podushki', dictGet(dict_kat, 'poduski_kat_code'), 'f3');
