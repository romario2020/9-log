 ...
 * Thu Sep 30 2021 15:41:42 GMT+1000 (Владивосток, стандартное время)
...
registerOnHover('poduski', false, function() {
  ...
  registerOnClick('poduski', false, false, [0,1,2], function() {
    outline('poduski', 'ENABLE');
    replaceTexture('poduski_small', 'podushka_3.jpg-texture.jpg', textura_img, function() {});
  }, function() {});
}, function() {
  outline('poduski', 'DISABLE');
});
registerOnHover('em_poduski_small', false, function() {
  outline('em_poduski_small', 'ENABLE');
  textura_img = getHTMLElemAttribute('src', 'm_odnotonra', true);
  registerOnClick('em_poduski_small', false, false, [0,1,2], function() {
    outline('em_poduski_small', 'ENABLE');
    replaceTexture('poduski_small', 'podushka_3.jpg-texture.jpg', textura_img, function() {});
  }, function() {});
}, function() {
...
registerOnHover('karkas', false, function() {
  ...
  registerOnClick('karkas', false, false, [0,1,2], function() {
    outline('karkas', 'ENABLE');
    replaceTexture('karkas', 'karkas.jpg-texture.jpg.001', textura_img, function() {});
  }, function() {});
}, function() {
...
eventHTMLElem('click', 'm_odnoton_ind', true, function(event) {
  ...
  registerOnHover('poduski', false, function() {
    ...
    registerOnClick('poduski', false, false, [0,1,2], function() {
      outline('poduski', 'ENABLE');
      replaceTexture('poduski', 'podushka_2.jpeg-texture.jpg', textura_img_ind, function() {});
      textura_img_ind = textura_img;
    }, function() {});
  }, function() {
    outline('poduski', 'DISABLE');
  ...
  registerOnHover('em_poduski_small', false, function() {
    ...
    registerOnClick('em_poduski_small', false, false, [0,1,2], function() {
      outline('em_poduski_small', 'ENABLE');
      replaceTexture('poduski_small', 'ao_podushki_small', textura_img_ind, function() {});
      textura_img_ind = textura_img;
    }, function() {});
  }, function() {
    outline('poduski', 'DISABLE');
  ...
  registerOnHover('karkas', false, function() {
    ...
    registerOnClick('karkas', false, false, [0,1,2], function() {
      outline('karkas', 'ENABLE');
      replaceTexture('karkas', 'karkas.jpg-texture.jpg.001', textura_img_ind, function() {});
      textura_img_ind = textura_img;
    }, function() {});
  }, function() {
    outline('karkas', 'DISABLE');
...
registerOnClick('karkas', false, false, [0,1,2], function() {
  ...
  dictSet(active_mash, 'podushki_small', 0);
}, function() {});
registerOnClick('osnova', false, false, [0,1,2], function() {
...
registerOnClick('em_poduski_small', false, false, [0,1,2], function() {
  ...
  dictSet(active_mash, 'osnova', 0);
  dictSet(active_mash, 'podushki', 0);
  dictSet(active_mash, 'podushki_small', 1);
}, function() {});
...
registerOnDrag('poduski', false, [0,1,2], function() {}, function() {
  setMaterialValue('poduski', 'Value.001', getEventProperty('pageX', event) / 100);
}, function() {}, 'B-%)Z7,K+egophKGsFF4');
registerOnDrag('poduski_small', false, [0,1,2], function() {}, function() {
  setMaterialValue('poduski_small', 'Value.001', getEventProperty('pageX', event) / 100);
}, function() {}, ',p7(5l+c/mTPRf~y2-o;');
...
eventHTMLElem('change', 'r3', true, function(event) {
  ...
  if (dictGet(active_mash, 'karkaz') == 1) {
    ...
    setMaterialValue('poduski', 'Value', cloth_size);
  } else if (dictGet(active_mash, 'podushki') == 1) {
    setMaterialValue('poduski', 'Value', cloth_size);
  }
});
